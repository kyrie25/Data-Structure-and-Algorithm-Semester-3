...
\end{figure}
    ...
    \begin{itemize}
        ...
        \item \textit{Insertion sort, Shaker sort: }Khi dữ liệu đã được sắp xếp, Insertion sort chỉ thực hiện một số lượng nhỏ phép so sánh vì thuật toán nhận ra dữ liệu đã có thứ tự. Số phép so sánh tăng chậm khi kích thước mảng tăng.
